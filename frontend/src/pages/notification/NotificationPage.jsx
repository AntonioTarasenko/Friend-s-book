    ...
    <div className='flex-[4_4_0] border-l border-r border-gray-700 min-h-screen pb-16 md:pb-0'>
      <div className='flex items-center p-4 border-b border-gray-700'>
        ...
        <div className='dropdown'>
          ...
          >
            <li>
              <a onClick={deleteNotifications}>Удалить все</a>
            </li>
          </ul>
        </div>
      </div>
        ...
        notifications.map((notification) => (
          <div className='border-b border-gray-700' key={notification._id}>
            <div className='flex gap-2 p-4'>
              ...
              {notification.type === 'hate' && (
                <FaPoop className='w-7 h-7 text-amber-900' />
              )}
              <Link to={`/profile/${notification.from.username}`}>
                ...
                <div className='flex gap-1'>
                  ...
                  {notification.type === 'follow' && 'теперь следит за тобой'}
